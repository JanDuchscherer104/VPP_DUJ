...
# Die benötigten Quelldateien werden in CMakeListsOld.txt festgelegt
...
Das googletest-Verzeichnis wird hier ebenfalls in CMakeListsOld.txt festgelegt (s. ~ Zeile 50)
